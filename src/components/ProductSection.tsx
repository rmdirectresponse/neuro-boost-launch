      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            <div className="mb-8">
              ...
              <h3 className="neuro-headline mb-6">
                <span className="text-gradient-neuro">MENTAL EXERCISE</span><br />
                <span className="text-foreground">PROGRAM</span>
              </h3>
              
              <p className="neuro-body text-muted-foreground mb-8 leading-relaxed">
                Revolutionary method developed by neuroscientists to optimize 
                your cognitive performance in just 21 days. Specific exercises that 
                strengthen memory, concentration and mental agility.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3 justify-center lg:justify-start">
                ...
                <span className="neuro-body font-semibold">+100 interactive exercises</span>
              </div>
              <div className="flex items-center gap-3 justify-center lg:justify-start">
                <div className="w-2 h-2 bg-secondary rounded-full"></div>
                <span className="neuro-body font-semibold">Real-time progress tracking</span>
              </div>
              <div className="flex items-center gap-3 justify-center lg:justify-start">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <span className="neuro-body font-semibold">Visible results in 7 days</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-border">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Guarantee Days</div>
          </div>
        </div>
      </div>
    </section>
